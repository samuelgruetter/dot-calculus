...
Proof.
  ...
  + (* case typ_sel_has *)
    ...
    apply invert_wf_sel in Wf. destruct Wf as [X1 [T [U [Bix1 [X1Has [WfX [WfT WfU]]]]]]].
    lets Eq: (binds_func Bix2' Bix2).
    lets N: (narrow_binds _ Bix2 St). destruct N as [X1 [Bix1 StX]].
